...
#
# from app_root.players.models import PlayerJob, \
...
# from app_root.servers.mixins import CONTENT_CATEGORY_UNION
# from app_root.servers.models import TSJobLocation, TSLocation, TSRegion
...
#     region = TSRegion.objects.create(asset_name='', content_category=CONTENT_CATEGORY_UNION)
#     location = TSLocation.objects.create(region=1)
#     job_location = TSJobLocation.objects.create(location=location, region=region)
