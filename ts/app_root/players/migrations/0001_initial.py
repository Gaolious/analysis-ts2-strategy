# Generated by Django 4.1.4 on 2023-03-07 15:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "expires_at",
                    models.DateTimeField(null=True, verbose_name="ExpiresAt"),
                ),
                (
                    "version",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sequence",
                    models.IntegerField(default=0, null=True, verbose_name="Sequence"),
                ),
                ...
                (
                    ...
                    models.IntegerField(default=0, verbose_name="ConditionMultiplier"),
                ),
                (
                    "reward_multiplier",
                    models.IntegerField(default=0, verbose_name="RewardMultiplier"),
                ),
                (
                    "required_amount",
                    models.IntegerField(default=0, verbose_name="required_amount"),
                ),
                (
                    "current_article_amount",
                    models.IntegerField(default=0, verbose_name="CurrentArticleAmount"),
                ),
                (
                    "reward",
                    models.CharField(default="", max_length=255, verbose_name="reward"),
                ),
                (
                    "bonus",
                    models.CharField(default="", max_length=255, verbose_name="bonus"),
                ),
                (
                    "expires_at",
                    models.DateTimeField(
                        default=None, null=True, verbose_name="ExpiresAt"
                    ),
                ),
                (
                    "requirements",
                ...
                (
                    "unlock_at",
                    models.DateTimeField(
                        default=None, null=True, verbose_name="UnlocksAt"
                    ),
                ),
                (
                    "collectable_from",
                    models.DateTimeField(
                        default=None, null=True, verbose_name="CollectableFrom"
                    ),
                ),
                (
                    "completed_at",
                    models.DateTimeField(
                        default=None, null=True, verbose_name="CompletedAt"
                    ),
                ),
                (
                    "job_location",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "leader_board_id",
                    models.CharField(
                        default="", max_length=50, verbose_name="LeaderboardId"
                    ),
                ),
                (
                    "leader_board_group_id",
                    models.CharField(
                        default="", max_length=50, verbose_name="LeaderboardGroupId"
                    ),
                ),
                (
                    "player_job",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "spawn_time",
                    models.DateTimeField(
                        blank=True, default=None, null=True, verbose_name="SpawnTime"
                    ),
                ),
                (
                    "collectable_from",
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        default=None,
                        null=True,
                        verbose_name="IsForVideoReward",
                    ),
                ),
                (
                    "expires_at",
                    models.DateTimeField(
                        blank=True, default=None, null=True, verbose_name="ExpiresAt"
                    ),
                ),
                (
                    "version",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "unlocked_at",
                    models.DateTimeField(null=True, verbose_name="UnlockedAt"),
                ),
                (
                    "job_location",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "instance_id",
                    models.IntegerField(default=0, verbose_name="instance_id"),
                ),
                (
                    "region",
                    models.IntegerField(
                        blank=True, default=None, null=True, verbose_name="region"
                    ),
                ),
                (
                    "has_route",
                    models.BooleanField(
                        blank=True, default=False, verbose_name="has route"
                    ),
                ),
                (
                    "route_type",
                ...
                (
                    ...
                    models.IntegerField(
                        ...
                        default=None,
                        null=True,
                        verbose_name="route_definition_id",
                    ),
                ),
                (
                    ...
                    models.DateTimeField(
                        ...
                        default=None,
                        null=True,
                        verbose_name="route_departure_time",
                    ),
                ),
                (
                    "route_arrival_time",
                    models.DateTimeField(
                        ...
                        default=None,
                        null=True,
                        verbose_name="route_arrival_time",
                    ),
                ),
                (
                    "has_load",
                    models.BooleanField(
                        blank=True, default=False, verbose_name="has load"
                    ),
                ),
                (
                    "load_amount",
                    models.IntegerField(default=0, verbose_name="load amount"),
                ),
                (
                    "level",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "definition_id",
                    models.IntegerField(null=True, verbose_name="definition_id"),
                ),
                (
                    "conditions",
                    models.CharField(
                        default="", max_length=255, verbose_name="Conditions"
                    ),
                ),
                (
                    "reward",
                ...
                (
                    "arrival_at",
                    models.DateTimeField(null=True, verbose_name="ArrivalAt"),
                ),
                ("expire_at", models.DateTimeField(null=True, verbose_name="ExpireAt")),
                (
                    "version",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "region_name",
                    models.CharField(
                        default="", max_length=20, verbose_name="region name"
                    ),
                ),
                ...
                (
                    "connections",
                    models.CharField(
                        default="", max_length=50, verbose_name="connections"
                    ),
                ),
                (
                    "is_resolved",
                    models.BooleanField(default=False, verbose_name="IsResolved"),
                ),
                (
                    "content",
                    models.CharField(
                        default="", max_length=255, verbose_name="region name"
                    ),
                ),
                (
                    "version",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "firebase_uid",
                    models.CharField(
                        default="", max_length=50, verbose_name="FirebaseUid"
                    ),
                ),
                (
                    "player_name",
                    models.CharField(
                        default="", max_length=50, verbose_name="player_name"
                    ),
                ),
                ("progress", models.IntegerField(default=0, verbose_name="progress")),
                ("position", models.IntegerField(default=0, verbose_name="position")),
                (
                    "last_updated_at",
                    models.DateTimeField(default=0, verbose_name="LastUpdatedAt"),
                ),
                (
                    "reward_claimed",
                    models.BooleanField(default=False, verbose_name="RewardClaimed"),
                ),
                (
                    "rewards",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "craft_time",
                    models.IntegerField(default=0, verbose_name="CraftTime"),
                ),
                (
                    "finish_time",
                    models.DateTimeField(
                        default=None, null=True, verbose_name="FinishTime"
                    ),
                ),
                (
                    "finishes_at",
                    models.DateTimeField(
                        default=None, null=True, verbose_name="FinishesAt"
                    ),
                ),
                (
                    "article",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "train_limit_count",
                    models.IntegerField(null=True, verbose_name="train_limit_count"),
                ),
                (
                    "train_limit_refresh_time",
                    models.DateTimeField(
                        null=True, verbose_name="train_limit_refresh_time"
                    ),
                ),
                (
                    "train_limit_refresh_at",
                    models.DateTimeField(
                        null=True, verbose_name="train_limit_refresh_at"
                    ),
                ),
                (
                    "multiplier",
                    models.IntegerField(
                        default="", null=True, verbose_name="multiplier"
                    ),
                ),
                (
                    "definition",
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        ...
                        default=None,
                        null=True,
                        verbose_name="AvailableFrom",
                    ),
                ),
                (
                    "expire_at",
                    models.DateTimeField(
                        blank=True, default=None, null=True, verbose_name="ExpireAt"
                    ),
                ),
                (
                    "rewards",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "price_amount",
                    models.IntegerField(default=0, verbose_name="Price Amount"),
                ),
                (
                    "reward",
                    models.CharField(default="", max_length=255, verbose_name="reward"),
                ...
                (
                    "purchase_count",
                    models.IntegerField(default=0, verbose_name="PurchaseCount"),
                ),
                (
                    "definition_id",
                    models.IntegerField(default=0, verbose_name="DefinitionId"),
                ),
                (
                    "daily_offer",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "last_bought_at",
                    models.DateTimeField(null=True, verbose_name="LastBoughtAt"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "contract_list_id",
                    models.IntegerField(default=0, verbose_name="contract list id"),
                ),
                (
                    "available_to",
                    models.DateTimeField(
                        default=None, null=True, verbose_name="Available To"
                    ),
                ),
                (
                    "next_replace_at",
                    models.DateTimeField(
                        default=None, null=True, verbose_name="Next Replace At"
                    ),
                ),
                (
                    "next_video_replace_at",
                    models.DateTimeField(
                        default=None, null=True, verbose_name="Next Video Replace At"
                    ),
                ),
                (
                    "next_video_rent_at",
                    models.DateTimeField(
                        default=None, null=True, verbose_name="Next Video Rent At"
                    ),
                ),
                (
                    "next_video_speed_up_at",
                    models.DateTimeField(
                        default=None, null=True, verbose_name="Next Video SpeedUp At"
                    ),
                ),
                (
                    "expires_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "usable_from",
                    models.DateTimeField(
                        default=None, null=True, verbose_name="UsableFrom"
                    ),
                ),
                (
                    "available_from",
                    models.DateTimeField(
                        default=None, null=True, verbose_name="AvailableFrom"
                    ),
                ),
                (
                    "available_to",
                    models.DateTimeField(
                        default=None, null=True, verbose_name="AvailableTo"
                    ),
                ),
                (
                    "expires_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.CharField(default="", max_length=20, verbose_name="Type"),
                ),
                (
                    "level_from",
                    models.IntegerField(null=True, verbose_name="LevelFrom"),
                ),
                (
                    "max_attendees",
                    models.IntegerField(null=True, verbose_name="MaxAttendees"),
                ),
                (
                    "competition_id",
                    models.CharField(
                        default="", max_length=50, verbose_name="CompetitionId"
                    ),
                ),
                (
                    "rewards",
                ...
                (
                    "enrolment_available_to",
                    models.DateTimeField(
                        null=True, verbose_name="EnrolmentAvailableTo"
                    ),
                ),
                (
                    "finishes_at",
                    models.DateTimeField(null=True, verbose_name="FinishesAt"),
                ),
                (
                    "expires_at",
                    models.DateTimeField(null=True, verbose_name="ExpiresAt"),
                ...
                (
                    "activated_at",
                    models.DateTimeField(null=True, verbose_name="ActivatedAt"),
                ),
                (
                    "progress",
                    models.CharField(
                        default="", max_length=255, verbose_name="Progress"
                    ),
                ),
                (
                    "presentation_data_id",
                    models.IntegerField(null=True, verbose_name="PresentationDataId"),
                ),
                (
                    "guild_data",
                    models.CharField(
                        default="", max_length=255, verbose_name="GuildData"
                    ),
                ),
                (
                    "scope",
                    models.CharField(default="", max_length=20, verbose_name="Scope"),
                ),
                (
                    "version",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "next_replace_at",
                    models.DateTimeField(
                        null=True, verbose_name="UpgradeTaskNextReplaceAt"
                    ),
                ),
                (
                    "next_video_replace_at",
                    models.DateTimeField(
                        null=True, verbose_name="UpgradeTaskNextVideoReplaceAt"
                    ),
                ),
                (
                    "version",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "instance_id",
                    models.IntegerField(null=True, verbose_name="instance id"),
                ),
                (
                    "definition_id",
                    models.IntegerField(null=True, verbose_name="instance id"),
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=255,
                        null=True,
                        verbose_name="upgrade task",
                    ),
                ),
                (
                    "parcel_number",
                    models.IntegerField(
                        default=None, null=True, verbose_name="parcel_number"
                    ),
                ),
                (
                    "version",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "achievement",
                    models.CharField(
                        default="", max_length=255, verbose_name="achievement"
                    ),
                ),
