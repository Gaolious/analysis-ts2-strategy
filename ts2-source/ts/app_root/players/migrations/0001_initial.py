    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position_x', models.IntegerField(default=0, verbose_name='SpotId')),
                ('position_y', models.IntegerField(default=0, verbose_name='SpotId')),
                ('connections', models.CharField(default='', max_length=50, verbose_name='region name')),
