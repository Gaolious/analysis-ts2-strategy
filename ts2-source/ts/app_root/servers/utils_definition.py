...
# from app_root.servers.models import SQLDefinition, TSArticle, TSUserLevel, TSWarehouseLevel, TSFactory, TSProduct, \
#     TSTrain, TSTrainLevel, TSRegion, TSLocation, TSDestination, TSJobLocation
...
#                 self.instance = SQLDefinition.objects.order_by('-pk').first()
#
#                 # try:
#                 if not self.instance or self.instance.version != version:
#                     self.instance = SQLDefinition.objects.create(
#                         version=version,
#                         checksum=checksum,
#                         url=url,
