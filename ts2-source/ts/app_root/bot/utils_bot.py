...
class Bot():
    ...
    init_data: InitdataHelper

    def __init__(self, user_id):
        self.user_id = user_id
        self.server_time = ServerTimeHelper()
        self.endpoints = EndpointHelper()
        self.login = LoginHelper()
        self.definition = DefinitionHelper()
        self.init_data = InitdataHelper()
        self.version = None
